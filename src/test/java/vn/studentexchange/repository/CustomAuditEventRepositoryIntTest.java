...
import vn.studentexchange.config.Constants;
import vn.studentexchange.config.audit.AuditEventConverter;
import vn.studentexchange.domain.PersistentAuditEvent;
...
import static vn.studentexchange.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
