  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="studentexchangeApp.country.delete.question">
          <Translate contentKey="studentexchangeApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
