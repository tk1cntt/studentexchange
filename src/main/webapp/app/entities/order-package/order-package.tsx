    ...
    return (
      <div>
        <h2 id="order-package-heading">
          <Translate contentKey="studentexchangeApp.orderPackage.home.title">Order Packages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.orderPackage.home.createLabel">Create new Order Package</Translate>
          </Link>
        </h2>
