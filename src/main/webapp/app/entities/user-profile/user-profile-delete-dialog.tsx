  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="studentexchangeApp.userProfile.delete.question">
          <Translate contentKey="studentexchangeApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
