...
public class UserShippingAddress implements Serializable {
    ...
    public UserShippingAddress createAt(Instant createAt) {
    ...
    public UserShippingAddress updateAt(Instant updateAt) {
    ...
    public boolean equals(Object o) {
        ...
        UserShippingAddress userShippingAddress = (UserShippingAddress) o;
        if (userShippingAddress.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), userShippingAddress.getId());
    }
