...
import vn.studentexchange.service.RegionService;
...
import vn.studentexchange.service.dto.RegionCriteria;
import vn.studentexchange.service.RegionQueryService;
...
public class RegionResourceIntTest {
    ...
    public void getAllRegionsByCountriesIsEqualToSomething() throws Exception {
        // Initialize the database
        Country countries = CountryResourceIntTest.createEntity(em);
