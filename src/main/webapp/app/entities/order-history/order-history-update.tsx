    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="studentexchangeApp.orderHistory.home.createOrEditLabel">
              <Translate contentKey="studentexchangeApp.orderHistory.home.createOrEditLabel">Create or edit a OrderHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
