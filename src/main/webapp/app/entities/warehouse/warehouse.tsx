    ...
    return (
      <div>
        <h2 id="warehouse-heading">
          <Translate contentKey="studentexchangeApp.warehouse.home.title">Warehouses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.warehouse.home.createLabel">Create new Warehouse</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="studentexchangeApp.warehouse.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="studentexchangeApp.warehouse.address">Address</Translate>
                </th>
                <th>
