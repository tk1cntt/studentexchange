    ...
    return (
      <div>
        <h2 id="delivery-heading">
          <Translate contentKey="studentexchangeApp.delivery.home.title">Deliveries</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.delivery.home.createLabel">Create new Delivery</Translate>
          </Link>
        </h2>
