  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="studentexchangeApp.orderItem.delete.question">
          <Translate contentKey="studentexchangeApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
