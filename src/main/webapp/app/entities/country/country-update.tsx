    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="studentexchangeApp.country.home.createOrEditLabel">
              <Translate contentKey="studentexchangeApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : countryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="nameLabel" for="name">
                    <Translate contentKey="studentexchangeApp.country.name">Name</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label id="enabledLabel" check>
                    ...
                    <Translate contentKey="studentexchangeApp.country.enabled">Enabled</Translate>
                  </Label>
                </AvGroup>
                <AvGroup>
                  <Label id="createAtLabel" for="createAt">
                    <Translate contentKey="studentexchangeApp.country.createAt">Create At</Translate>
                  </Label>
                  <AvInput
                    id="country-createAt"
                    type="datetime-local"
                    ...
                    name="createAt"
                    value={isNew ? null : convertDateTimeFromServer(this.props.countryEntity.createAt)}
                  />
                </AvGroup>
                <AvGroup>
                  <Label id="updateAtLabel" for="updateAt">
                    <Translate contentKey="studentexchangeApp.country.updateAt">Update At</Translate>
                  </Label>
                  <AvInput
                    id="country-updateAt"
                    type="datetime-local"
                    className="form-control"
                    name="updateAt"
                    value={isNew ? null : convertDateTimeFromServer(this.props.countryEntity.updateAt)}
                  />
                </AvGroup>
                <AvGroup>
                  <Label for="region.id">
