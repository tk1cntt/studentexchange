    ...
    return (
      <div>
        <h2 id="delivery-package-heading">
          <Translate contentKey="studentexchangeApp.deliveryPackage.home.title">Delivery Packages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.deliveryPackage.home.createLabel">Create new Delivery Package</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="studentexchangeApp.deliveryPackage.createBy">Create By</Translate>
                </th>
                <th>
                  <Translate contentKey="studentexchangeApp.deliveryPackage.updateBy">Update By</Translate>
                </th>
                <th />
              </tr>
            </thead>
