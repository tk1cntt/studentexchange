    ...
    return (
      <div>
        <h2 id="order-transaction-heading">
          <Translate contentKey="studentexchangeApp.orderTransaction.home.title">Order Transactions</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.orderTransaction.home.createLabel">Create new Order Transaction</Translate>
          </Link>
        </h2>
