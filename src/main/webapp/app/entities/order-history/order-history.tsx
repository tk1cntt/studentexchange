    ...
    return (
      <div>
        <h2 id="order-history-heading">
          <Translate contentKey="studentexchangeApp.orderHistory.home.title">Order Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.orderHistory.home.createLabel">Create new Order History</Translate>
          </Link>
        </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="studentexchangeApp.orderHistory.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="studentexchangeApp.orderHistory.description">Description</Translate>
                </th>
                <th>
            ...
            <tbody>
              {orderHistoryList.map((orderHistory, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`studentexchangeApp.OrderStatus.${orderHistory.status}`} />
                  </td>
