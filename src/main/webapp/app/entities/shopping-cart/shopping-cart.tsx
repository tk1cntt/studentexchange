    ...
    return (
      <div>
        <h2 id="shopping-cart-heading">
          <Translate contentKey="studentexchangeApp.shoppingCart.home.title">Shopping Carts</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.shoppingCart.home.createLabel">Create new Shopping Cart</Translate>
          </Link>
        </h2>
