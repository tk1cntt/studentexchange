    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="studentexchangeApp.orderComment.home.createOrEditLabel">
              <Translate contentKey="studentexchangeApp.orderComment.home.createOrEditLabel">Create or edit a OrderComment</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
                ...
                <AvGroup>
                  ...
                  >
                    <option value="CUSTOMER_LOG">
                      <Translate contentKey="studentexchangeApp.CommentType.CUSTOMER_LOG" />
                    </option>
                    <option value="CUSTOMER_CHAT">
                      <Translate contentKey="studentexchangeApp.CommentType.CUSTOMER_CHAT" />
                    </option>
                    <option value="STAFF_LOG">
                      <Translate contentKey="studentexchangeApp.CommentType.STAFF_LOG" />
                    </option>
                    <option value="STAFF_CHAT">
                      <Translate contentKey="studentexchangeApp.CommentType.STAFF_CHAT" />
                    </option>
                    <option value="SYSTEM_LOG">
                      <Translate contentKey="studentexchangeApp.CommentType.SYSTEM_LOG" />
                    </option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
