    ...
    return (
      <div>
        <h2 id="order-package-history-heading">
          <Translate contentKey="studentexchangeApp.orderPackageHistory.home.title">Order Package Histories</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.orderPackageHistory.home.createLabel">Create new Order Package History</Translate>
          </Link>
        </h2>
