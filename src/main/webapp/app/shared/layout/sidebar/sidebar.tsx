      ...
      <nav className="navbar-default navbar-static-side" role="navigation">
        <div className="sidebar-collapse">
          <ul className="nav metismenu" id="side-menu">
            ...
            <li>
              <a href="#">
                <i className="fa fa-bar-chart-o" /> <span className="nav-label">Graphs</span>
            ...
            <li>
              <a href="mailbox.html">
                <i className="fa fa-envelope" /> <span className="nav-label">Mailbox </span>
            ...
            <li>
              <a href="metrics.html">
                <i className="fa fa-pie-chart" /> <span className="nav-label">Metrics</span>
              </a>
            </li>
            <li>
              <a href="widgets.html">
                <i className="fa fa-flask" /> <span className="nav-label">Widgets</span>
              </a>
            </li>
            <li>
              <a href="#">
                <i className="fa fa-edit" /> <span className="nav-label">Forms</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="#">
                <i className="fa fa-desktop" /> <span className="nav-label">App Views</span>{' '}
            ...
            <li>
              <a href="#">
                <i className="fa fa-files-o" /> <span className="nav-label">Other Pages</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="#">
                <i className="fa fa-globe" /> <span className="nav-label">Miscellaneous</span>
            ...
            <li>
              <a href="#">
                <i className="fa fa-flask" /> <span className="nav-label">UI Elements</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="grid_options.html">
                <i className="fa fa-laptop" /> <span className="nav-label">Grid options</span>
              </a>
            </li>
            <li>
              <a href="#">
                <i className="fa fa-table" /> <span className="nav-label">Tables</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="#">
                <i className="fa fa-shopping-cart" /> <span className="nav-label">E-commerce</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="#">
                <i className="fa fa-picture-o" /> <span className="nav-label">Gallery</span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="#">
                <i className="fa fa-sitemap" /> <span className="nav-label">Menu Levels </span>
                <span className="fa arrow" />
              </a>
              <ul className="nav nav-second-level collapse">
                <li>
            ...
            <li>
              <a href="css_animation.html">
                <i className="fa fa-magic" /> <span className="nav-label">CSS Animations </span>
                <span className="label label-info pull-right">62</span>
              </a>
            </li>
            <li className="landing_link">
              <a target="_blank" href="landing.html">
                <i className="fa fa-star" /> <span className="nav-label">Landing Page</span>{' '}
                <span className="label label-warning pull-right">NEW</span>
              </a>
            </li>
            <li className="special_link">
              <a href="package.html">
                <i className="fa fa-database" /> <span className="nav-label">Package</span>
              </a>
            </li>
          </ul>
        </div>
