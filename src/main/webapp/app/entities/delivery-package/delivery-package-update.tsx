    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="studentexchangeApp.deliveryPackage.home.createOrEditLabel">
              <Translate contentKey="studentexchangeApp.deliveryPackage.home.createOrEditLabel">Create or edit a DeliveryPackage</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
