  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="studentexchangeApp.payment.delete.question">
          <Translate contentKey="studentexchangeApp.payment.delete.question" interpolate={{ id: paymentEntity.id }}>
