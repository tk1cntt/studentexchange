    ...
    return (
      <div>
        <h2 id="user-shipping-address-heading">
          <Translate contentKey="studentexchangeApp.userShippingAddress.home.title">User Shipping Addresses</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="studentexchangeApp.userShippingAddress.home.createLabel">Create new User Shipping Address</Translate>
          </Link>
        </h2>
